  ...
  <div class="container col-xl-10 col-xxl-8 px-4 py-5">
    <div class="row align-items-center g-lg-5 py-5">
      <div class="col-lg-7 text-center text-lg-start">
        <h1 class="display-4 fw-bold lh-1 text-body-emphasis mb-3">Je me connecte à mon compte</h1>
        <p class="col-lg-10 fs-4">Votre compte vous permet de gérer au même endroit vos annonces, vos messages, vos alertes e-mail et tous vos outils favoris (estimations, dossier location, quittances...).</p>
      </div>
