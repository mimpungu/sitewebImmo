...
<div class="b-example-divider"></div>
    <div class="container my-5">
        <div class="position-relative p-5 text-center text-muted bg-body border border-dashed rounded-5">
            ...
            <h1 class="text-body-emphasis">Estimation de bien immobilier</h1>
            <p class="lead">Répondez à quelques questions pour obtenir une estimation gratuite et rapide de votre bien immobilier.</p>
           
            <a href="search.php" type="button" class="btn btn-primary px-5 mb-5 btn-lg" name="btn_begin" > Commencer </a>
        </div>
    </div>
